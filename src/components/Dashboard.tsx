...
import { SonnerProvider } from "./ui/feedback/sonner";
...
import { ComponentsOrganizationPage } from "./pages/components-organization-page";
...
const components = [
  { name: " Home", id: "home", page: HomePage },
  {
    name: " Organização",
    id: "organization",
    page: ComponentsOrganizationPage,
  },
...
export function Dashboard() {
  ...
  return (
    <SonnerProvider position="bottom-right" maxToasts={5}>
      <motion.div
