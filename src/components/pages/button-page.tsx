    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          Botões com diferentes variantes, tamanhos e estados para interações do
          usuário.
        </p>
      </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              <Card>
                ...
                <CardContent className="space-y-3">
                  ...
                  <Button className="w-full" leftIcon={<Download size={16} />}>
                    Assinar Agora
                  </Button>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Botões para ações comuns</CardDescription>
                </CardHeader>
                <CardContent>
