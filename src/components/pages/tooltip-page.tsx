        ...
        <div className="space-y-8 p-6">
          <div>
            ...
            <p className="text-muted-foreground mt-2">
              Componente de dica contextual que aparece ao passar o mouse ou
            ...
            <div className="grid gap-6">
                            ...
                            <TooltipContent>
                              <div className="max-w-xs">
                                <p>
                                  ...
                                  explicação mais detalhada para melhor
                                  compreensão.
                                </p>
                              </div>
                            </TooltipContent>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Usando tooltips para auxiliar no preenchimento de
                    formulários
                  </CardDescription>
                </CardHeader>
                <CardContent>
                ...
                <CardContent>
                    ...
                    <div className="space-y-3">
                      ...
                      <ul className="space-y-2 text-sm">
                        ...
                        <li className="flex items-start gap-2">
                          ...
                          <span>
                            Inclua atalhos de teclado quando relevante
                          </span>
                        </li>
                        <li className="flex items-start gap-2">
                          <Badge
                          ...
                          <span>
                            Use para contextualizar dados e estatísticas
                          </span>
                        </li>
                        <li className="flex items-start gap-2">
                          <Badge
                    ...
                    <div className="space-y-3">
                      ...
                      <ul className="space-y-2 text-sm">
                        ...
                        <li className="flex items-start gap-2">
                          ...
                          <span>
                            Tooltips em elementos móveis ou que se movem
                          </span>
                        </li>
                        <li className="flex items-start gap-2">
                          <Badge
                        ...
                        <li className="flex items-start gap-2">
                          ...
                          <span>
                            Tooltips que bloqueiam interações importantes
                          </span>
                        </li>
                      </ul>
                    </div>
                  ...
                  <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                    ...
                    <p className="text-sm text-blue-700">
                      Tooltips devem ser acessíveis via teclado e leitores de
                      tela. O componente Tooltip do shadcn/ui já inclui as
                      propriedades ARIA adequadas. Para elementos customizados,
                      considere usar as props `aria-label` ou `aria-describedby`
                      quando appropriate.
                    </p>
                  </div>
                </CardContent>
