    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          Componente de barra de progresso para mostrar o andamento de tarefas e
          processos.
        </p>
      </div>
      ...
      <div className="grid gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Barras de progresso com diferentes cores para diferentes contextos
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-2">
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3 p-3 border rounded-lg">
                  ...
                  <Badge className="bg-green-600 hover:bg-green-700">✓</Badge>
                </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3 p-3 border rounded-lg">
                  <div className="flex-1 space-y-2">
                    ...
                    <Progress value={77} className="h-2 [&>div]:bg-blue-500" />
                  </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Simulando um progresso contínuo para tarefas sem duração definida
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-2">
