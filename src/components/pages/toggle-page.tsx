        ...
        <div className="space-y-8 p-6">
          <div>
            ...
            <p className="text-muted-foreground mt-2">
              Componente de alternância para estados ligado/desligado com design
              de botão.
            </p>
          </div>
                ...
                <div className="space-y-6">
                  <div className="space-y-4">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Formatação de texto - múltiplas opções podem ser
                      selecionadas
                    </p>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Alinhamento de texto - apenas uma opção pode ser
                      selecionada
                    </p>
                  </div>
