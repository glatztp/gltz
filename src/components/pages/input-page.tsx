      ...
      <div className="grid gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Input com toggle de visibilidade</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid md:grid-cols-2 gap-4">
              <div className="space-y-2">
          ...
          <CardContent>
            <div className="grid md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input id="normal" type="text" placeholder="Estado normal" />
              </div>
              <div className="space-y-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Para entrada de texto multilinha</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid md:grid-cols-2 gap-4">
              <div className="space-y-2">
