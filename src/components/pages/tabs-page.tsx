        ...
        <div className="space-y-8 p-6">
          <div>
            ...
            <p className="text-muted-foreground mt-2">
              Componente de abas para organizar e alternar entre diferentes
              seções de conteúdo.
            </p>
          </div>
                ...
                <Tabs defaultValue="tab1" className="w-full">
                  ...
                  <TabsContent value="tab1" className="mt-4">
                    <div className="p-4 border rounded-lg">
                      ...
                      <p className="text-muted-foreground">
                        ...
                        colocar qualquer conteúdo como texto, formulários,
                  ...
                  <TabsContent value="tab2" className="mt-4">
                    <div className="p-4 border rounded-lg">
                      ...
                      <p className="text-muted-foreground">
                        Conteúdo completamente diferente para a segunda aba. As
                        abas são uma excelente forma de organizar informações
                  ...
                  <TabsContent value="tab3" className="mt-4">
                    <div className="p-4 border rounded-lg">
                      ...
                      <p className="text-muted-foreground">
                        ...
                        quantas abas precisar para organizar seu conteúdo de
                        forma eficiente.
                      </p>
                    </div>
                  </TabsContent>
                ...
                <Tabs defaultValue="overview" className="w-full">
                  ...
                  <TabsContent value="analytics" className="mt-4">
                    <div className="p-6 border rounded-lg text-center">
                      ...
                      <p className="text-muted-foreground">
                        Aqui você encontraria gráficos e métricas detalhadas
                        sobre o desempenho.
                      </p>
                    </div>
                  </TabsContent>
                ...
                <Tabs defaultValue="active" className="w-full">
                  ...
                  <TabsContent value="active" className="mt-4">
                    <div className="p-4 border rounded-lg">
                      ...
                      <p className="text-muted-foreground">
                        Esta aba está ativa por padrão e mostra como o
