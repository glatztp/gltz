        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <Alert className="border-blue-500 bg-blue-50 text-blue-800">
              <AlertDescription>
                Dica: Você pode personalizar os alertas com cores diferentes.
              </AlertDescription>
            </Alert>
          </CardContent>
        </Card>
          ...
          <CardContent className="space-y-4">
            <Alert className="border-yellow-500 bg-yellow-50 text-yellow-800">
              ...
              <AlertDescription className="mb-3">
                ...
                atualizar para obter as últimas funcionalidades e correções de
                segurança.
              </AlertDescription>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <Alert className="border-orange-500 bg-orange-50 text-orange-800">
                ...
                <AlertDescription className="mb-3">
                  Você está usando 90% do seu espaço disponível (4.5GB de 5GB).
                </AlertDescription>
                <div className="flex gap-2">
                  <Button
                    size="sm"
            ...
            <Alert className="border-purple-500 bg-purple-50 text-purple-800">
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <AlertDescription>
                    Como usuário premium, você tem acesso a suporte prioritário
                    e funcionalidades exclusivas.
                  </AlertDescription>
                </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <Alert className="border-teal-500 bg-teal-50 text-teal-800">
              ...
              <AlertDescription className="mb-3">
                Escaneamento de segurança concluído. Nenhuma ameaça detectada.
              </AlertDescription>
            ...
            <Alert className="border-pink-500 bg-pink-50 text-pink-800">
              ...
              <AlertDescription className="mb-3">
                Parabéns! Hoje faz 1 ano que você se juntou à nossa plataforma.
                🎉
              </AlertDescription>
              <div className="flex items-center gap-2">
