            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Descrição adicional do card</CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-sm text-muted-foreground">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Ícone integrado ao título</CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                ...
                <CardHeader>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <CardDescription>Recursos profissionais</CardDescription>
                    </div>
                  </div>
                </CardHeader>
